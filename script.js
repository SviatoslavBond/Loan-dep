...
/* harmony import */ var _modules_play__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/play */ "./src/js/modules/play.js");
...
/* harmony import */ var _modules_slider_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/slider */ "./src/js/modules/slider/slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  new _modules_play__WEBPACK_IMPORTED_MODULE_4__["default"]('.showup__video .play', '.overlay').init();
  new _modules_play__WEBPACK_IMPORTED_MODULE_4__["default"]('.module__video-item .play', '.overlay').init();
  new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_7__["default"]({
    container: '.page',
    btns: '.next'
  }).render();
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show .plus').showMore();
  ...
  new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_8__["default"]({
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"]({
    educationOld: '.officerold',
    educationNew: '.officernew',
    trigger: '.plus'
  }).init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_2__["default"]({
    forms: '.form'
  }).init();
  new _modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"]('[name = "phone"]').init();
});
...
function () {
  function Difference(_ref) {
    var educationOld = _ref.educationOld,
        educationNew = _ref.educationNew,
        trigger = _ref.trigger;

    _classCallCheck(this, Difference);

    try {
      this.old = document.querySelector(educationOld);
      this.new = document.querySelector(educationNew);
      this.oldItems = this.old.children;
      this.newItems = this.new.children;
      this.oldBtn = this.old.querySelector(trigger);
      this.newBtn = this.new.querySelector(trigger);
      this.showIndexOld = 1;
      this.showIndexNew = 1;
    } catch (e) {}
  }
  ...
  _createClass(Difference, [{
    key: "showMore",
    value: function showMore(parent, index) {
      if (index <= parent.length - 2) {
        parent[index].style.opacity = '1';
        parent[index].style.height = '83px';
        parent[index].style.marginTop = '17px';

        if (index === parent.length - 2) {
          parent[index + 1].style.opacity = '0';
        }
      }
    }
  }, {
    key: "bindTrigger",
    value: function bindTrigger(btn, items, counter) {
      var _this = this;

      btn.addEventListener('click', function () {
        return _this.showMore(items, counter++);
      });
    }
  }, {
    key: "hideContent",
    value: function hideContent(column) {
      var _this2 = this;

      column.forEach(function (item, i) {
        item.style.transition = 'all .5s';

        if (i == 0 || i == _this2.oldItems.length - 1) {
          return;
        } else {
    ...
    value: function init() {
      try {
        this.bindTrigger(this.oldBtn, this.oldItems, this.showIndexOld);
        this.bindTrigger(this.newBtn, this.newItems, this.showIndexNew);
...
function () {
  ...
  _createClass(Download, [{
    key: "downloadItem",
    value: function downloadItem(path, e) {
    ...
    value: function init() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          _this.downloadItem(_this.path, e);
        });
      });
    }
  }]);
...
function () {
  ...
  _createClass(Form, [{
    key: "postDate",
    value: function postDate(url, data) {
      var res;
    ...
    value: function sendForm() {
      ...
      this.forms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (e) {
          ...
          _this.postDate('assets/question.php', formDate).then(function (res) {
            console.log(res);
            textMessage.textContent = _this.message.succses;
          }).catch(function (er) {
            textMessage.textContent = _this.message.fail;
          }).finally(function () {
...
function () {
  ...
  _createClass(Mask, [{
    ...
    value: function createMask(event) {
      ...
      var val = this.value.replace(/\D/g, ''); //  видаляє з введденого текста все що не є цифрою, і результат записується в перемінну val
      ...
      if (event.type === 'blur') {
        ...
        this.focus(); //вручну встановлюється focus на  інпуті
    ...
    value: function init() {
      ...
      this.inputs.forEach(function (input) {
        input.addEventListener('input', _this.createMask);
        input.addEventListener('focus', _this.createMask);
        input.addEventListener('blur', _this.createMask);
        input.addEventListener('click', _this.createMask);
      });
    }
  }]);
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, overlay, container) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        try {
          if (btn.closest('.module__video-item').querySelector('.play__circle').classList.contains('closed')) {
    ...
    value: function bindCloseBtn() {
      ...
      this.overlay.addEventListener('click', function (e) {
        ...
        if (target.classList.contains('close') || target == _this2.overlay) {
    ...
    value: function onPlayerStateChange(state) {
      try {
        if (state.data == 0) {
          var svgBtn = this.activeBtn.querySelector('svg').cloneNode(true);
          var blockedElem = this.activeBtn.closest('.module__video-item').nextElementSibling;

          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            blockedElem.querySelector('.play__circle').classList.remove('closed');
            blockedElem.querySelector('svg').remove();
            blockedElem.querySelector('.play__circle').appendChild(svgBtn);
  ...
  _createClass(ShowInfo, [{
    ...
    value: function showMore() {
      this.triggers.forEach(function (btn) {
        var msg = btn.closest('.module__info-show').nextElementSibling;
        btn.addEventListener('click', function () {
          msg.classList.toggle('active-msg');
        });
      });
    }
  }]);
...
function (_Slider) {
  ...
  function SliderMain() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).apply(this, arguments));
  }
  ...
  _createClass(SliderMain, [{
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            ...
            _this.hanson.classList.add('zoomInDown');
          }, 3000);
        } else {
          this.hanson.classList.remove('zoomInDown');
        }
      } catch (e) {}
    ...
    value: function bindTrigger() {
      ...
      this.btns.forEach(function (btn) {
        //Переключення активних слайдів
        btn.addEventListener('click', function (e) {
          _this2.plusSlides(1);
        });
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          // При кліці на лого переключається на перший слайд
    ...
    value: function render() {
      if (this.container) {
        ...
        this.showSlides(); //Перша ініціалізація слайдера
...
function (_Slider) {
  ...
  function SliderMini(container, prev, next, activeClass, autoplay, animate) {
    var _this;

    _classCallCheck(this, SliderMini);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, prev, next, activeClass, autoplay, animate));
  ...
  _createClass(SliderMini, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        if (!_this3.isButton) {
          var current = _this3.slides[_this3.slides.length - 1];

          _this3.container.insertBefore(current, _this3.slides[0]);
        } else {
          var _current = _this3.slides[_this3.slides.length - 3];

          _this3.container.insertBefore(_current, _this3.slides[0]);
        }
